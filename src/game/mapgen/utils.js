...
/**
 * Civ4 BTS seed modulo — seeds are constrained to [0, 73637380].
 * From CvGame.cpp: m_mapRand.init(GC.getInitCore().getMapRandSeed() % 73637381);
 */
export const CIV4_SEED_MODULO = 73637381;
